...
#| warning: false
#| eval: false
db <- dbConnect(duckdb(), "legislators.duckdb")

legislators <- read_csv("data/legislators.csv.gz",
                        show_col_types = FALSE)
copy_to(db, legislators,
        name = "legislators",
        overwrite = TRUE, temporary = FALSE)

legislators_terms <- read_csv("data/legislators_terms.csv.gz",
                              show_col_types = FALSE)
copy_to(db, legislators_terms,
...
```{r}
db <- dbConnect(duckdb(), "legislators.duckdb", read_only = TRUE)
```
