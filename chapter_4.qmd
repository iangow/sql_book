...
legislators <- read_csv(paste0(url, "legislators.csv"),
                        show_col_types = FALSE)
copy_to(db, legislators, name = "legislators")

legislators_terms <- read_csv(paste0(url, "legislators_terms.csv"),
                              show_col_types = FALSE)
copy_to(db, legislators_terms, name = "legislators_terms")
```
