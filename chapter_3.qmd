...
This chapter is really two chapters.
The first part of the chapter discusses some finer details of dates, date-times, and time stamps.
This material is important, but a little technical and bewildering wihtout some concrete use cases.
...
A first-time reader could probably skip ahead to @sec-retail-data without much loss.
...
Alternatively, we could just grab a CSV file from the GitHub repository for @tanimura2021sql.
