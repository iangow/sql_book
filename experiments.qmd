...
We can get these data from the [GitHub site](https://github.com/cathytanimura/sql_book) associated with @tanimura2021sql.^[I `compute()` two tables so that I can refer to them using SQL below.]
